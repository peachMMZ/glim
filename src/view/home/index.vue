<template>
  <div>
    <div class="h-full flex flex-col gap-y-2 p-2">
      <NCard>
        ...
        <div class="space-y-6">
          <div class="flex justify-between">
            ...
            <div class="flex items-center">
              <NButton type="primary" text :render-icon="renderIcon(Settings2)" @click="showServerSetting">服务设置</NButton>
            </div>
          </div>
      ...
      <div>
        <NGrid :cols="4" :x-gap="10" :y-gap="10">
          <NGridItem v-for="nav in navList" :key="nav.label">
            <NCard class="cursor-pointer" hoverable @click="nav.onClick">
